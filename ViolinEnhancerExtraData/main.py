...
GENERATOR_LEARNING_RATE = 6e-7    # Range from about  0.0001 to 0.1
DISCRIMINATOR_LEARNING_RATE = 6e-7    # Range from about  0.0001 to 0.1
...
GAMMA = 0
PRINT_FREQ = 5
LAMBDA = 15 # For gradient penalty
