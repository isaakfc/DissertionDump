...
for e in range(1, EPOCHS+1):
    ...
    for batch_idx in range(batch_count):
        ...
        if n_critic_count >= N_CRITIC:
            # Train generator
            total_g_loss, r_loss, g_loss, p_loss, generated_spectrograms = train.WGAN_GP_train_g_step(x_genuine_batch,
                                                                                              x_noisy_batch,
                                                                                              discriminatorModel,
                                                                                              generatorModel,
                                                                                              generator_optimizer,
        ...
        if (batch_idx + 1) % PRINT_FREQ == 0:
            ...
            f"Generator Loss: {g_loss:.4f}, / Reconstruction Loss: {r_loss:.4f},/ Perceptual Loss: {p_loss:.4f},"
