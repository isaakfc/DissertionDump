...
GENERATOR_LEARNING_RATE = 3e-6    # Range from about  0.0001 to 0.1
DISCRIMINATOR_LEARNING_RATE = 3e-6    # Range from about  0.0001 to 0.1
...
GAMMA = 0.25
PRINT_FREQ = 5
LAMBDA = 20 # For gradient penalty
...
for e in range(1, EPOCHS+1):
    ...
    for batch_idx in range(batch_count):
        ...
        d_loss = train.WGAN_GP_train_d_step(x_genuine_batch,
                                             x_noisy_batch,
                                             discriminatorModel,
                                             generatorModel,
