...
GENERATOR_LEARNING_RATE = 5e-5    # Range from about  0.0001 to 0.1
DISCRIMINATOR_LEARNING_RATE = 6e-6    # Range from about  0.0001 to 0.1
MIN_LR = 0.000001 # Minimum value of learning rate
DECAY_FACTOR = 1.00004 # learning rate decay factor
EPOCHS = 10             # Range from about 5 to 100
L2_REG = 0.5           # Range from about 0 to 0.01
BATCH_SIZE = 16   # Range from 16 to 512 (for audio from about 8 to 128)
...
GAMMA = 1
PRINT_FREQ = 5
LAMBDA = 25  # For gradient penalty
...
for e in range(1, EPOCHS+1):
    ...
    for batch_idx in range(batch_count):
        ...
        if (batch_idx + 1) % PRINT_FREQ == 0:
            ...
            f"Generator Loss: {g_loss:.4f}, / Reconstruction Loss: {r_loss:.4f}, Total generator Loss: {total_g_loss:.4f}")
